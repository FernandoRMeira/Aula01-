...
# Porque numpy: oferece desempenho e ferramentas superiores á biblioteca padrão.
...
# 3- Dá para fazer ainda melhor se definirmos o tipo de dado, exemplo: dado tipo int8 (para valores de 8 - 255)
# start_time = time.time ()
...
# Numpy ja tem métodos bem diretos de como salvar um arquivo no formato .txt
